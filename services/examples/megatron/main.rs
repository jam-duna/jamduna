...
extern "C" fn accumulate() -> u32 {
    ...
    unsafe {
        ...
        let s0_n = u32::from_le_bytes(service0_result.try_into().unwrap());
        let s0_vn = u32::from_le_bytes(service0_result.try_into().unwrap());
        let s0_vnminus1 = u32::from_le_bytes(service0_result.try_into().unwrap());
