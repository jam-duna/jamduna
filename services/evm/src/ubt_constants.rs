//! UBT tree layout constants (EIP-6800-compatible)
//!
//! These constants define the UBT tree key structure for EVM state.
...
/// UBT tree branch width (number of children per node)
pub const UBT_NODE_WIDTH: usize = 256;
