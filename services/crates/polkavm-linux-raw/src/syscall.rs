...
macro_rules! syscall_readonly {
    ...
    ($nr:expr, $a0:expr, $a1:expr, $a2:expr, $a3:expr) => {
        $crate::syscall_impl::syscall4_readonly(
            $nr.into(),
            $a0.into(),
            $a1.into(),
            $a2.into(),
    ...
    ($nr:expr, $a0:expr, $a1:expr, $a2:expr, $a3:expr, $a4:expr) => {
        $crate::syscall_impl::syscall5_readonly(
            $nr.into(),
            $a0.into(),
            $a1.into(),
            $a2.into(),
    ...
    ($nr:expr, $a0:expr, $a1:expr, $a2:expr, $a3:expr, $a4:expr, $a5:expr) => {
        $crate::syscall_impl::syscall6_readonly(
            $nr.into(),
            $a0.into(),
            $a1.into(),
            $a2.into(),
