...
pub mod debug_info {
    pub use polkavm_common::program::{
        FrameInfo, FrameKind, LineProgram, RegionInfo, SourceLocation,
    };
...
pub mod program {
    pub use polkavm_common::program::{
        ISA32_V1_NoSbrk, Imports, ImportsIter, Instruction, InstructionSet, Instructions,
        JumpTable, JumpTableIter, Opcode, ParsedInstruction, ProgramExport, ProgramParseError,
        ProgramSymbol, RawReg, ISA32_V1, ISA64_V1,
    };
}
...
pub use crate::config::{
    BackendKind, Config, CustomCodegen, GasMeteringKind, ModuleConfig, SandboxKind,
};
