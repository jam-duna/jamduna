...
// This test file is excluded from regular builds because it references
// statedb.CreateSignedUSDMTransfer and statedb.DefaultJAMChainID which
// have been moved. Use rollup_rpc_test.go for RPC integration tests.
