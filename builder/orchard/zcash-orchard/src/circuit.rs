...
impl VerifyingKey {
    ...
    /// Builds the verifying key using caller-provided params.
...
impl ProvingKey {
    ...
    /// Builds the proving key using caller-provided params.
    pub fn build_with_params(
        params: halo2_proofs::poly::commitment::Params<vesta::Affine>,
    ) -> Self {
        let circuit: Circuit = Default::default();
    ...
    /// Constructs a proving key from params and an existing halo2 proving key.
    pub fn from_parts(
        params: halo2_proofs::poly::commitment::Params<vesta::Affine>,
        pk: plonk::ProvingKey<vesta::Affine>,
    ) -> Self {
