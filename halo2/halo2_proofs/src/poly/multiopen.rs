...
use crate::collections::{vec, BTreeMap, BTreeSet, Vec};
use core::hash::Hash;
    ...
    I: IntoIterator<Item = Q> + Clone,
{
    ...
    // their queries.
    let mut commitment_map: IndexMap<
        Q::Commitment,
        CommitmentData<Option<Q::Eval>, ()>,
        RandomState,
    ...
    let mut commitment_set_map = IndexMap::with_hasher(RandomState::default());
