...
// Forward declaration of Go function (will be provided via CGO export)
extern void goDebugPrintInstruction(uint32_t opcode, uint64_t pc, void* reg_dump_addr);

// Get the function pointer to the debug print function
void* getDebugPrintInstructionPtr() {
    return (void*)goDebugPrintInstruction;
}
