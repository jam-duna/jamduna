...
void handle_STORE_IND_U8(VM* vm, uint8_t* operands, size_t operand_len) {
    ...
    int err_code = vm_write_ram_bytes_8(vm, addr, value);
    if (err_code != OK) {
...
#if PVM_TRACE
        dump_store_generic("STORE_IND_U8", (uint64_t)addr, reg_name(register_index_a), (uint64_t)value, 8);
#endif
...
void handle_STORE_IND_U16(VM* vm, uint8_t* operands, size_t operand_len) {
    ...
    int err_code = vm_write_ram_bytes_16(vm, addr, value);
    if (err_code != OK) {
        vm_panic(vm, err_code);
        return;
    }
...
#if PVM_TRACE
        dump_store_generic("STORE_IND_U16", (uint64_t)addr, reg_name(register_index_a), (uint64_t)value, 16);
#endif
...
void handle_STORE_IND_U32(VM* vm, uint8_t* operands, size_t operand_len) {
    ...
    int err_code = vm_write_ram_bytes_32(vm, addr, value);
    if (err_code != OK) {
        vm_panic(vm, err_code);
        return;
    }
...
#if PVM_TRACE
        dump_store_generic("STORE_IND_U32", (uint64_t)addr, reg_name(register_index_a), (uint64_t)value, 32);
#endif
...
void handle_STORE_IND_U64(VM* vm, uint8_t* operands, size_t operand_len) {
    ...
    int err_code = vm_write_ram_bytes_64(vm, addr, value_a);
    if (err_code != OK) {
        vm_panic(vm, err_code);
        return;
    }
...
#if PVM_TRACE
        dump_store_generic("STORE_IND_U64", (uint64_t)addr, reg_name(register_index_a), value_a, 64);
#endif
...
void handle_LOAD_IND_U8(VM* vm, uint8_t* operands, size_t operand_len) {
    ...
    int err_code;
    uint8_t value = vm_read_ram_bytes_8(vm, addr, &err_code);
    if (err_code != OK) {
        vm_panic(vm, err_code);
        return;
    }
...
#if PVM_TRACE
        dump_load_generic("LOAD_IND_U8", register_index_a, (uint64_t)addr, result, 8, 0);
#endif
...
#if PVM_TRACE
        dump_load_generic("LOAD_IND_I8", register_index_a, (uint64_t)addr, result, 8, 1);
#endif
...
void handle_LOAD_IND_U16(VM* vm, uint8_t* operands, size_t operand_len) {
    ...
    int err_code;
    uint16_t value = vm_read_ram_bytes_16(vm, addr, &err_code);
    if (err_code != OK) {
        vm_panic(vm, err_code);
        return;
    }
...
#if PVM_TRACE
        dump_load_generic("LOAD_IND_U16", register_index_a, (uint64_t)addr, result, 16, 0);
#endif
...
#if PVM_TRACE
        dump_load_generic("LOAD_IND_I16", register_index_a, (uint64_t)addr, result, 16, 1);
#endif
...
void handle_LOAD_IND_U32(VM* vm, uint8_t* operands, size_t operand_len) {
    ...
    int err_code;
    uint32_t value = vm_read_ram_bytes_32(vm, addr, &err_code);
    if (err_code != OK) {
        vm_panic(vm, err_code);
        return;
    }
...
#if PVM_TRACE
        dump_load_generic("LOAD_IND_U32", register_index_a, (uint64_t)addr, result, 32, 0);
#endif
...
#if PVM_TRACE
        dump_load_generic("LOAD_IND_I32", register_index_a, (uint64_t)addr, result, 32, 1);
#endif
...
void handle_LOAD_IND_U64(VM* vm, uint8_t* operands, size_t operand_len) {
    ...
    int err_code;
    uint64_t loaded_value = vm_read_ram_bytes_64(vm, memory_address, &err_code);
    if (err_code != OK) {
        vm_panic(vm, err_code);
        return;
    }
...
#if PVM_TRACE
        dump_load_generic("LOAD_IND_U64", register_index_a, (uint64_t)memory_address, loaded_value, 64, 0);
#endif
...
#if PVM_TRACE
        dump_bin_op("+", register_index_a, register_index_b, vx, result);
#endif
...
#if PVM_TRACE
        dump_cmp_op("<u", register_index_a, register_index_b, vx, result);
#endif
...
#if PVM_TRACE
        dump_cmp_op("<s", register_index_a, register_index_b, vx, result);
#endif
...
#if PVM_TRACE
        dump_shift_op("<<", register_index_a, register_index_b, vx, result);
#endif
...
void handle_SHLO_R_IMM_32(VM* vm, uint8_t* operands, size_t operand_len) {
    ...
    uint64_t value_b = vm->registers[register_index_b];
    uint32_t shift32 = (uint32_t)value_b >> (vx & 31);
...
#if PVM_TRACE
        dump_rot_op("ROT_R_64_IMM", reg_name(register_index_a), reg_name(register_index_b), vx, result);
#endif
...
#if PVM_TRACE
        dump_rot_op("ROT_R_64_IMM_ALT", reg_name(register_index_a), reg_name(register_index_b), vx, result);
#endif
...
#if PVM_TRACE
        dump_rot_op("ROT_R_32_IMM", reg_name(register_index_a), reg_name(register_index_b), vx, result);
#endif
...
#if PVM_TRACE
        dump_rot_op("ROT_R_32_IMM_ALT", reg_name(register_index_a), reg_name(register_index_b), vx, result);
#endif
...
#if PVM_TRACE
        dump_cmov_op("== 0", register_index_a, register_index_b, vx, value_a, result, 1);
#endif
...
#if PVM_TRACE
        dump_cmov_op("!= 0", register_index_a, register_index_b, vx, value_a, result, 0);
#endif
