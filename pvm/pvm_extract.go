...
func extractOneOffset(args []byte) (vx int64) {
	originalOperands := slices.Clone(args)
...
func extractOneRegOneImm(args []byte) (reg1 int, vx uint64) {
...
func extractOneReg2Imm(args []byte) (reg1 int, vx uint64, vy uint64) {
...
func extractTwoRegsOneOffset(args []byte) (registerIndexA, registerIndexB int, vx int64) {
	registerIndexA = min(12, int(args[0])%16)
...
func extractTwoRegsAndTwoImmediates(operands []byte) (registerIndexA, registerIndexB int, vx, vy uint64) {
