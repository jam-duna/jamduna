...
func (c *NodeClient) GetBlockByHash(blockHash common.Hash, fullTx bool) (*EthereumBlock, error) {
...
func (c *NodeClient) GetBlockByNumber(blockNumber string, fullTx bool) (*EthereumBlock, error) {
	var block EthereumBlock
