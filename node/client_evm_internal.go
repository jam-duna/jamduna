...
func (c *NodeClient) GetChainId() uint64 {
	var result string
	err := c.client.Call("eth_chainId", []string{}, &result)
	if err != nil {
		log.Warn(log.Node, "NodeClient.GetChainId RPC failed, using default", "err", err)
		return jamChainID
	}
	...
	if err != nil {
		log.Warn(log.Node, "NodeClient.GetChainId parse failed, using default", "err", err)
		return jamChainID
	}
...
func (c *NodeClient) GetAccounts() []common.Address {
	var result []string
	err := c.client.Call("eth_accounts", []string{}, &result)
	if err != nil {
		log.Warn(log.Node, "NodeClient.GetAccounts RPC failed", "err", err)
...
func (c *NodeClient) GetGasPrice() uint64 {
	var result string
	err := c.client.Call("eth_gasPrice", []string{}, &result)
	if err != nil {
		log.Warn(log.Node, "NodeClient.GetGasPrice RPC failed, using default", "err", err)
		return 1000000000 // 1 gwei
	}

	gasPrice, err := strconv.ParseUint(result[2:], 16, 64)
	if err != nil {
		log.Warn(log.Node, "NodeClient.GetGasPrice parse failed, using default", "err", err)
		return 1000000000
	}
...
func (c *NodeClient) GetBalance(address common.Address, blockNumber string) (common.Hash, error) {
	var result string
...
func (c *NodeClient) GetStorageAt(address common.Address, position common.Hash, blockNumber string) (common.Hash, error) {
	var result string
...
func (c *NodeClient) GetTransactionCount(address common.Address, blockNumber string) (uint64, error) {
	var result string
...
func (c *NodeClient) GetCode(address common.Address, blockNumber string) ([]byte, error) {
	var result string
...
func (c *NodeClient) EstimateGas(from common.Address, to *common.Address, gas uint64, gasPrice uint64, value uint64, data []byte) (uint64, error) {
...
func (c *NodeClient) Call(from common.Address, to *common.Address, gas uint64, gasPrice uint64, value uint64, data []byte, blockNumber string) ([]byte, error) {
	txObj := map[string]interface{}{
		"from": from.String(),
	}
	if to != nil {
...
func (c *NodeClient) SendRawTransaction(signedTxData []byte) (common.Hash, error) {
...
func (c *NodeClient) GetTransactionReceipt(txHash common.Hash) (*EthereumTransactionReceipt, error) {
...
func (c *NodeClient) GetTransactionByHash(txHash common.Hash) (*EthereumTransactionResponse, error) {
	var tx EthereumTransactionResponse
...
func (c *NodeClient) GetLogs(fromBlock, toBlock uint32, addresses []common.Address, topics [][]common.Hash) ([]EthereumLog, error) {
...
func (c *NodeClient) GetLatestBlockNumber() (uint32, error) {
	var result string
...
func (c *NodeClient) GetTransactionByBlockHashAndIndex(blockHash common.Hash, index uint32) (*EthereumTransactionResponse, error) {
...
func (c *NodeClient) GetTransactionByBlockNumberAndIndex(blockNumber string, index uint32) (*EthereumTransactionResponse, error) {
	indexHex := fmt.Sprintf("0x%x", index)
	var tx EthereumTransactionResponse
