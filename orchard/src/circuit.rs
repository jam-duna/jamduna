...
impl VerifyingKey {
    ...
    /// Writes the verifying key to the given writer in canonical Halo2 format.
    #[cfg(feature = "std")]
    pub fn write_vk<W: std::io::Write>(&self, mut writer: W) -> std::io::Result<()> {
        self.vk.write(&mut writer)
    }

    /// Writes the IPA params to the given writer in canonical Halo2 format.
    #[cfg(feature = "std")]
    pub fn write_params<W: std::io::Write>(&self, mut writer: W) -> std::io::Result<()> {
